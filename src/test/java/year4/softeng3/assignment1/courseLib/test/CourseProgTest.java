...
public class CourseProgTest {
    ...
    private Module testModule = new Module("Test Module","TM111", Arrays.asList(testStudent));
    private List<Module> testModules = Arrays.asList(testModule);
    ...
    void shouldAddModuleAddsModuleIfNotAlreadyAdded() {
        ...
        Module newModule = new Module("Second Test Module", "TY111", Arrays.asList(testStudent));
        List expectedModules = Arrays.asList(testModule, newModule);
    ...
    void shouldNotAddModuleIfAlreadyAdded() {
        Module newModule = new Module("Second Test Module", "TY111", Arrays.asList(testStudent));
        List<Module> modifiedTestModules = Arrays.asList(testModule, newModule);
